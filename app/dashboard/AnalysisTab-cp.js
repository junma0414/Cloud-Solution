...
import { FiCopy, FiSave, FiRefreshCw } from 'react-icons/fi'; // Add FiRefreshCw
...
const handleRefresh = () => {
  setRefreshTrigger(prev => prev + 1); // Just increment to trigger useEffect
};
...
>
 ...
 <div className={getChartClass('drift')} onClick={() => handleChartClick('drift')}>
  ...
  selectedWord={selectedNERWord} 
      ...
      { header: 'Chat Diaglog TS', accessor: 'session_dialog_dt' },
