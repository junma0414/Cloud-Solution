...
async def analyze_text(
  ...
  '''
        ...
        "project_name": "dummy_proj",  # Default as per table schema
        "model_name": "dummy_model",   # Default as per table schema
        ...
        response_data = { "success": True, "result": scores, "timestamp": datetime.now().isoformat()}
